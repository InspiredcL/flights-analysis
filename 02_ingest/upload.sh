...
# Cambiamos permisos usando access control list (acl) con change (ch) de manera recursiva (-R) al grupo de usuarios (-g) allUsers con permisos de lectura (:R) del BUCKET en cuestión.
