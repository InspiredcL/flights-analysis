#### DO NOT EDIT! Autogenerated from ../10_mlops/train_on_vertexai.py# Copyright 2017-2021 Google Inc. All Rights Reserved.
#
...
def train_automl_model(data_set, timestamp, develop_mode):
    ...
    model = job.run(
        ...
        export_evaluated_data_items_bigquery_destination_uri='{}:dsongcp.ch11_automl_evaluated'.format(PROJECT),
...
@dsl.pipeline(name="flights-ch11-pipeline",
              description="ds-on-gcp ch11 flights pipeline"
)
def main():
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--bucket',
        help='Data will be read from gs://BUCKET/ch11/data and checkpoints will be in gs://BUCKET/ch11/trained_model',
        required=True
    )
    parser.add_argument(
        '--region',
